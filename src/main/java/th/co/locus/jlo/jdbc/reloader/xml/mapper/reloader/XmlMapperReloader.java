...
import th.co.locus.jlo.jdbc.reloader.utils.ReflectionUtil;
...
public class XmlMapperReloader implements MapperReloader {
    ...
    public void reload(Set<String> resources) {
        ...
        try {
            ...
            log.error("Cannot load MyBatis XML Mappers", e);
        }

        sw.stop();
        log.info("Loaded MyBatis XML Mappers in {}ms", sw.getTime());
    }
