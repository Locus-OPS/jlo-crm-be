...
#   docker run -d --name jlo-crm-be -p 8080:8080 -e PORT=8080 -e TZ=Asia/Bangkok -v C:/tmp/logs:/tmp/logs jlo-crm-be
...
# 3. Create folders for attachments and logs.
...
# Enable to mount Attachment path and log folder.
